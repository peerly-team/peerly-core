...
internal sealed class UpdateSubmittedHomeworkCommandValidator : ICommandValidator<UpdateSubmittedHomeworkCommand, Success>
{
    private readonly ICommonUnitOfWorkFactory _unitOfWorkFactory;
    private readonly IClock _clock;

    public UpdateSubmittedHomeworkCommandValidator(ICommonUnitOfWorkFactory unitOfWorkFactory, IClock clock)
    {
        _unitOfWorkFactory = unitOfWorkFactory;
        _clock = clock;
    }

    public async Task<CommandValidationResult> ValidateAsync(UpdateSubmittedHomeworkCommand command, CancellationToken cancellationToken)
    {
