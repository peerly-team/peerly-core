...
internal sealed class CreateSubmittedHomeworkFileValidator : ICreateSubmittedHomeworkFileValidator
{
    private readonly IHomeworkSubmissionAccessValidator _accessValidator;
    private readonly ICommonUnitOfWorkFactory _unitOfWorkFactory;

    public CreateSubmittedHomeworkFileValidator(IHomeworkSubmissionAccessValidator accessValidator, ICommonUnitOfWorkFactory unitOfWorkFactory)
    {
        _accessValidator = accessValidator;
        _unitOfWorkFactory = unitOfWorkFactory;
    }

    public async Task<OtherError?> RunAsync(CreateSubmittedHomeworkFileCommand command, CancellationToken cancellationToken)
    {
