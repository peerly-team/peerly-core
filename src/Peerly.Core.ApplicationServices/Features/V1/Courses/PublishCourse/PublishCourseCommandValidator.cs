...
internal sealed class PublishCourseCommandValidator : ICommandValidator<PublishCourseCommand, Success>
{
    private readonly ICommonUnitOfWorkFactory _commonUnitOfWorkFactory;

    public PublishCourseCommandValidator(ICommonUnitOfWorkFactory commonUnitOfWorkFactory)
    {
        _commonUnitOfWorkFactory = commonUnitOfWorkFactory;
    }

    public async Task<CommandValidationResult> ValidateAsync(PublishCourseCommand command, CancellationToken cancellationToken)
    {
        ...
        {
            return ValidationError.From(CourseErrors.IncorrectCourseStatusForPublish);
        }
