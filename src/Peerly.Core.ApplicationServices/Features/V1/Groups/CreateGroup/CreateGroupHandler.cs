...
internal sealed class CreateGroupHandler : ICommandHandler<CreateGroupCommand, CreateGroupCommandResponse>
{
    ...
    private readonly ICommandValidator<CreateGroupCommand, CreateGroupCommandResponse> _validator;
    private readonly IClock _clock;

    public CreateGroupHandler(
        ICommonUnitOfWorkFactory commonUnitOfWorkFactory,
        ICommandValidator<CreateGroupCommand, CreateGroupCommandResponse> validator,
        IClock clock)
    {
