...
internal sealed class GetStudentHomeworkQueryValidator : IQueryValidator<GetStudentHomeworkQuery, GetStudentHomeworkQueryResponse>
{
    private readonly ICommonUnitOfWorkFactory _unitOfWorkFactory;

    public GetStudentHomeworkQueryValidator(ICommonUnitOfWorkFactory unitOfWorkFactory)
    {
        _unitOfWorkFactory = unitOfWorkFactory;
    }

    public async Task ValidateAsync(GetStudentHomeworkQuery query, CancellationToken cancellationToken)
    {
