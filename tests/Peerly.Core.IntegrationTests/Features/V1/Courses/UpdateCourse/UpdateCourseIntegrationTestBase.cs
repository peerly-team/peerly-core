...
public abstract class UpdateCourseIntegrationTestBase : IAsyncLifetime
{
    protected UpdateCourseIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected UpdateCourseGrpcClient UpdateCourseClient => Fixture.UpdateCourseClient;
