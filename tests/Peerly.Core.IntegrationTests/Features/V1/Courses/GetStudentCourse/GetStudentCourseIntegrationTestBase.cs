...
public abstract class GetStudentCourseIntegrationTestBase : IAsyncLifetime
{
    protected GetStudentCourseIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected GetStudentCourseGrpcClient GetStudentCourseClient => Fixture.GetStudentCourseClient;
