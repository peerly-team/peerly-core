...
public abstract class PublishCourseIntegrationTestBase : IAsyncLifetime
{
    protected PublishCourseIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected PublishCourseGrpcClient PublishCourseClient => Fixture.PublishCourseClient;
