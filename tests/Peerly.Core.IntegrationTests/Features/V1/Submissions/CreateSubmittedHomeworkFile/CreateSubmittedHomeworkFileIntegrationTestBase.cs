...
public abstract class CreateSubmittedHomeworkFileIntegrationTestBase : IAsyncLifetime
{
    protected CreateSubmittedHomeworkFileIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected CreateSubmittedHomeworkFileGrpcClient CreateSubmittedHomeworkFileClient => Fixture.CreateSubmittedHomeworkFileClient;
