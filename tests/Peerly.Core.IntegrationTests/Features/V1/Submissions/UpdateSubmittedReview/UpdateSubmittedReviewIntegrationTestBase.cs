...
public abstract class UpdateSubmittedReviewIntegrationTestBase : SubmissionIntegrationTestBase
{
    protected UpdateSubmittedReviewIntegrationTestBase(IntegrationTestFixture fixture)
        : base(fixture)
    {
    }

    protected UpdateSubmittedReviewGrpcClient UpdateSubmittedReviewClient => Fixture.UpdateSubmittedReviewClient;
