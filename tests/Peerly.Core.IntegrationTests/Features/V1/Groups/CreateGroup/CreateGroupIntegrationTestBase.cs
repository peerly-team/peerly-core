...
public abstract class CreateGroupIntegrationTestBase : IAsyncLifetime
{
    protected CreateGroupIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected CreateGroupGrpcClient CreateGroupClient => Fixture.CreateGroupClient;
