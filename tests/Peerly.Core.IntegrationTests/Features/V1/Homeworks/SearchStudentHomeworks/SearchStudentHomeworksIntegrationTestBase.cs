...
public abstract class SearchStudentHomeworksIntegrationTestBase : IAsyncLifetime
{
    protected SearchStudentHomeworksIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected SearchStudentHomeworksGrpcClient SearchStudentHomeworksClient => Fixture.SearchStudentHomeworksClient;
