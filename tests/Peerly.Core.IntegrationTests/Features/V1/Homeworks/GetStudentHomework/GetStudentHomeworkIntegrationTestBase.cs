...
public abstract class GetStudentHomeworkIntegrationTestBase : IAsyncLifetime
{
    protected GetStudentHomeworkIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected GetStudentHomeworkGrpcClient GetStudentHomeworkClient => Fixture.GetStudentHomeworkClient;
