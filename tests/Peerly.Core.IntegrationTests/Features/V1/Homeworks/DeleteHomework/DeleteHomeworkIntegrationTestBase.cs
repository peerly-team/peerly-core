...
public abstract class DeleteHomeworkIntegrationTestBase : IAsyncLifetime
{
    protected DeleteHomeworkIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected DeleteHomeworkGrpcClient DeleteHomeworkClient => Fixture.DeleteHomeworkClient;
