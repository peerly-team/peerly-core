...
public abstract class ListTeacherCourseHomeworksIntegrationTestBase : IAsyncLifetime
{
    protected ListTeacherCourseHomeworksIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected ListTeacherCourseHomeworksGrpcClient ListTeacherCourseHomeworksClient => Fixture.ListTeacherCourseHomeworksClient;
