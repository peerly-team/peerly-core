...
public abstract class UpdateTeacherIntegrationTestBase : IAsyncLifetime
{
    protected UpdateTeacherIntegrationTestBase(IntegrationTestFixture fixture)
    {
        Fixture = fixture;
    }
    ...
    protected UpdateTeacherGrpcClient UpdateTeacherClient => Fixture.UpdateTeacherClient;
